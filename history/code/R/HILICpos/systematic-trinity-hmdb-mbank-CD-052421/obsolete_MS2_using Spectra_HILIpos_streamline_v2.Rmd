...
for (i in (1:length(sps_select_l))) { 
  ...
  if(max(res_l[[i]]) > threshold) {
    ...
    sps_final_l[[i]]$db_compound_id <- mbank_best_match$spectrum_id
    ...
    sps_final_l[[i]]$db_precursorMz <- mbank_best_match$precursorMz # important
...
for (i in (1:length(sps_select_l))) { 
  ...
  if(max(res_l[[i]]) > threshold) {
    ...
    sps_final_l[[i]]$db_spectrum_precursorMz <- hmdb_best_match$precursorMz # important

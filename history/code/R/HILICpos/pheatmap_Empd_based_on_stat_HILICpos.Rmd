...
spcific note: This notebook is copy from R_Pneg version
originated from: "/Users/gongm/Documents/projects/Rafi_Ahmed_exhaustedCD8Tcell/code/R/C18neg/pheatmap_Empd_based_on_stat_R_Pneg.Rmd"
---
...
is_positive_mode <- TRUE #positive mode: TRUE; negative mode: False

key_name <- paste("HILICpos_R5posvsR5neg","mcgpadj",mcg_pval_thres ,"FTpadj",FT_padj_threshold,"adduct_abundant",only_abundant_adduct, "simpl_path",simplified_path_label, sep = "_")
```
...
# [1] "8"   "10"  "773" "780" "903" "17"  "20"  "230" "31"  "642"
```
...
lofCpd_df_clean$massfeature_rows[1:10]
#  8     10    773    780    903     17     20    230     31    642 
# "0008" "0010" "0773" "0780" "0903" "0017" "0020" "0230" "0031" "0642" 
```
...
# [1] "FT0008" "FT0010" "FT0773" "FT0780" "FT0903"
```
...
## Write the table of the filtered result
```{r}
write.csv(filt_m_df, paste0(output_dir, key_name,"full_table.csv"))
```

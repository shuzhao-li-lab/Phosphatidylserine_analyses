---
title: "pheatmap Empd based on mcg stat"
mode: "RPneg"
date: 04182021
general note: This script is used to perform heatmap visualization on mcg result
spcific note: This particular notebook is the 1st note book for pheatmap practice. And thus is rewritten in RPneg script 
originated from: "/Users/gongm/Documents/projects/Rafi_Ahmed_exhaustedCD8Tcell/code/R/RPneg/pheatmap_Empd_based_on_stat_HILICpos.R"
---

## Library and clean up the environment
...
output_dir <- "../../../data/output/v0412_fix/RPneg/heatmaps_based_on_mcg_res/"
dir.create(output_dir)
```


## set some parameters for later session
```{r}
...
simplified_path_label <- TRUE 
is_positive_mode <- FALSE #negative mode: False

key_name <- paste("RPneg_R5posvsR5neg","mcgpadj",mcg_pval_thres ,"FTpadj",FT_padj_threshold,"adduct_abundant",only_abundant_adduct, "simpl_path",simplified_path_label, sep = "_")
```
...
mcg_res_fdr <- "../../../data/output/v0412_fix/RPneg/mcg_RPneg/R5posvsR5neg/1618701569.613964.mcg_C18neg_padj_default_0.05_R5posvsR5neg/"
...
featab <- read.csv("../../../data/output/v0412_fix/RPneg/feature_summary/featureValues_summarized_log2scale.csv")

ttest_res_df <- read.table("../../../data/output/v0412_fix/RPneg/ttest_equal/ttest_res_full_report_R5posvsR5neg.txt", header = 1)
...
# [1] "pathway"                         "overlap_size"                    "pathway_size"                    "p.value"                        
# [5] "overlap_EmpiricalCompounds..id." "overlap_features..id."           "overlap_features..name." 
...
lofCpd_df_clean$massfeature_rows[1:10]
# [1] "3"   "15"  "19"  "27"  "48"  "53"  "103" "53"  "54"  "106"
```
...
lofCpd_df_clean$massfeature_rows[1:10]
    # 3     15     19     27     48     53    103     53     54    106 
#   "0003" "0015" "0019" "0027" "0048" "0053" "0103" "0053" "0054" "0106" 
```


```{r}
lofCpd_df_clean$massfeature_rows <- paste0("FT",lofCpd_df_clean$massfeature_rows)
lofCpd_df_clean$massfeature_rows[1:5]
```

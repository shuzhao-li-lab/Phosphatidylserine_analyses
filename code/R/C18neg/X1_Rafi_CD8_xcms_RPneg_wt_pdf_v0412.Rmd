...
dir.create(output_dir1)
output_dir2 = "../../../data/output/v0412_fix/RPneg/xcms/"
...
## Perform the correspondence
pdp <- PeakDensityParam(sampleGroups = xdata$sample_group,
                        minFraction = 0.7, bw = 2)   # Here I use 0.7 to get at least 2 samples have the features.
...
saveRDS(xdata, file = paste(output_dir,"RPneg_xcms_minFrac07_bw2_ppm1_sum.rds",sep = ""))
# Restore the object

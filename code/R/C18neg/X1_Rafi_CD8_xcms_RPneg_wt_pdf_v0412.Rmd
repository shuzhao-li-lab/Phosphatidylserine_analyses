...
dir.create(output_dir1)
output_dir2 = paste0(output_dir1,"cor_wt_binSize0.002/")
...
pdp <- PeakDensityParam(sampleGroups = xdata$sample_group,
                        minFraction = 0.7, bw = 2, binSize = 0.002)
```
...
## Perform the correspondence
pdp <- PeakDensityParam(sampleGroups = xdata$sample_group,
                        minFraction = 0.7, bw = 2, binSize = 0.002)   # Here I use 0.7 to get at least 2 samples have the features.
...
saveRDS(xdata, file = paste(output_dir,"RPneg_xcms_minFrac07_bw2_ppm1_sum_binSize0.02.rds",sep = ""))
# Restore the object

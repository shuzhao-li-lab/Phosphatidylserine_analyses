...
note: This is the reanalysis of the HILICpos data because of HILIC/RP data mislabeled.
---
...
```{r}
output_dir1 = "../../../data/output/HILICpos_0402/"
dir.create(output_dir1)
output_dir2 = "../../../data/output/HILICpos_0402/xcms/"
...
j = 1
for (mz in mzr_l) {
  chr_raw <- chromatogram(raw_data, mz = c(mz-0.008, mz+0.008), rt = rtr)
  plot(chr_raw, col = group_colors[chr_raw$sample_group], sub = internal_df$Internal_stsandard[j])
  j = j + 1
}
dev.off()
...
mzr <- c(mzr_l[3]-0.005, mzr_l[3]+0.005)
...
saveRDS(xdata, file = paste(output_dir,"HILICpos_xcms_minFrac07.rds",sep = ""))
# Restore the object

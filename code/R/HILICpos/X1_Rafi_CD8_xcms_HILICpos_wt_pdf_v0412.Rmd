...
output_dir1 = paste0(output_dir1,"HILICpos/")
dir.create(output_dir1)
...
saveRDS(raw_data, file = paste(output_dir,"raw_data.rds",sep = ""))
# Restore the object
...
pdp <- PeakDensityParam(sampleGroups = xdata$sample_group,
                        minFraction = 0.7, bw = 2, binSize = 0.005) #Still need to be tested.
```
...
```{r}
# Save an object to a file
saveRDS(xdata, file = paste(output_dir,"HILICpos_xcms_minFrac07_bw2_ppm1_sum_binSize0.005.rds",sep = ""))
# Restore the object
#readRDS(file = "my_data.rds")
```
